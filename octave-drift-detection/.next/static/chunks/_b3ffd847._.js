(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_b3ffd847._.js", {
...
const getUseCasesForUser = async (user)=>{
...
// Enhanced mode configuration with colors, descriptions, and icons
const modeConfig = {
    mode1: {
        label: "OCTAVE_RG",
        color: "text-blue-700",
        bgColor: "bg-blue-50 border-blue-200",
        description: "Risk Governance",
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ModeSelection.useEffect": ()=>{
            async function load() {
                ...
                setError(null);
                // Mock user for demo
                const u = "demo.user@company.com" || localStorage.getItem("currentUser");
                if ("TURBOPACK compile-time falsy", 0) {
                    "TURBOPACK unreachable";
                }
                setUser(u);
                try {
                    const data = await getUseCasesForUser(u);
                    if (!data.length) {
...
//# sourceMappingURL=_b3ffd847._.js.map